...
import './ProgramApplicationDetail.css';
...
function ProgramApplicationDetail() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await Axios.post('http://localhost:5000/api/submit-programapplicationdetail', formData, {
                headers: {
            ...
            if (response) {
                ...
                // navigate("/AcadamicQualificationDetail");
            } else {
